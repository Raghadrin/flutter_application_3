  ...
  final List<Map<String, dynamic>> stories = [
    {
      ...
      'paragraph': 'في صباحٍ مشمس، ذهب سامي مع والده إلى الحديقة. كانت الأشجار خضراء، والعصافير تغني. لعب سامي كثيرًا بالأرجوحة والزحليقة، ثم جلس مع والده ليتناولا العصير ويشاهدوا الطيور وهي تطير في السماء',
    ...
    },
    {
      'emoji': '🌧️',
      'title': 'ألعاب المطر',
      'paragraph': 'في فصل الشتاء، تهطل الأمطار وتصبح الأرض مبللة. يخرج الأطفال بفرح ليلعبوا في البرك الصغيرة، ويصنعوا قوارب ورقية يتركونها تبحر في الماء. يرتدون المعاطف والأحذية الطويلة ليبقوا جافين أثناء اللعب',
    ...
    },
    {
      'emoji': '📖',
      'title': 'قصة قبل النوم',
      'paragraph': 'تحب سارة قراءة القصص قبل النوم. تجلس بجانب والدتها وتفتح كتابها المفضل. كل ليلة، تسافر بخيالها إلى أماكن جميلة من خلال القصص، وتحلم بأنها بطلة في عالم من المغامرات',
    ...
    },
    {
      'emoji': '🏫',
      'title': 'في المدرسة',
      'paragraph': 'في المدرسة، يتعلم التلاميذ القراءة والكتابة والحساب. يحب الأطفال معلميهم لأنهم يشجعونهم دائمًا على التعلم والاجتهاد. في الفصل، يتشاركون في الأنشطة ويعملون معًا كفريق',
    ...
    },
    {
      ...
      'paragraph': 'ذهبت العائلة إلى البحر في العطلة. لعب الأطفال بالرمل وبنوا قلاعًا كبيرة. سبحوا في الماء وركضوا على الشاطئ. بعد اللعب، جلسوا معًا وتناولوا طعامًا لذيذًا وهم يشاهدون الأمواج',
