...
class _OperationChoiceGameState extends State<OperationChoiceGame>
  ...
  final List<Map<String, dynamic>> _questions = [
    ...
    },
    {
      ...
      'hint': [
        {
          'text':
              'This game helps you learn how to pick the right math operation!'
        },
      ],
    }
  ];
  ...
  Widget _buildEquationBox(String content) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.orangeAccent.withOpacity(0.5), blurRadius: 8)
        ],
      ),
      child: Text(
        content,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Operation Choice",
            style: TextStyle(
                fontSize: 40,
              ...
              child: finished
                  ? Column(
                      ...
                      children: [
                        ...
                        _buildFeedbackBox(
                            "🎉 You Did Very Well! 🎉", Colors.green),
                        const SizedBox(height: 30),
                        ElevatedButton(
                  ...
                  : SingleChildScrollView(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text("Solve the below question",
                              style: TextStyle(
                                  fontSize: 40,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black87),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: parts
                                .map<Widget>((p) => _buildEquationBox(p))
                                .toList(),
                          ),
                          const SizedBox(height: 30),
                          Container(
