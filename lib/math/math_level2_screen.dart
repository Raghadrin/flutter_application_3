...
import 'package:flutter_application_3/math/math_games/hard_equation_game.dart';
import 'package:flutter_application_3/math/math_games/operation_sequence_game.dart';
import 'package:flutter_application_3/math/math_quizes/game_audio_helper.dart';
import 'package:flutter_application_3/math/math_quizes/level2_quiz.dart';
        ...
        children: [
          ...
          _buildGameButton(context, "Solve Two-Step Equations", () {
            GameAudioHelper.speak(
                "Solve two-step equations like 2 plus 3 times 2.");
            Navigator.push(context,
                MaterialPageRoute(builder: (_) => OperationSequenceGame()));
          }),
          _buildGameButton(context, "Find the Missing Number", () {
            GameAudioHelper.speak(
                "Find the missing number in equations like x times 3 equals 12.");
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => HardEquationGame()));
          }),
          Divider(height: 40),
          _buildGameButton(context, "Test What You Learned", () {
            GameAudioHelper.sayStartQuiz();
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => Level2Quiz()));
          }),
        ],
      ),
    );
